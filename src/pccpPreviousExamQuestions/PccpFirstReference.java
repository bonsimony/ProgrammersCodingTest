...
public class PccpFirstReference {
    ...
    public static void main(String[] args) {
        ...
        public static String solution(String video_len, String pos, String op_start, String op_end, String[] commands) {
            ...
            iOpStart = Integer.parseInt(op_start.split(":")[0]) * 60 + Integer.parseInt(op_start.split(":")[1]);
            iOpEnd = Integer.parseInt(op_end.split(":")[0]) * 60 + Integer.parseInt(op_end.split(":")[1]);
            ...
            a = String.valueOf(iPos / 60);
            b = String.valueOf(iPos % 60);
